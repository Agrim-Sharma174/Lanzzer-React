...
const SignUp = () => {
  return (
    <>
        ...
        <p class="text-slate-500">Hi, Welcome to Lanzzer 👋</p>
        ...
        <form action="" class="my-10">
            <div class="flex flex-col space-y-5">
                ...
                <p class="text-center">Alreday have an account ? <a href="#" class="text-indigo-600 font-medium inline-flex space-x-1 items-center">
                <Link to="/">
                <span>Login </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                  </svg></span>
                  </Link>
                  </a></p>
            </div>
